...
\paragraph{Sjekk.}
Utestengelsen bør testes for i \textbf{brukstilfelle~2} (booking).
Før en booking godkjennes, sjekker applikasjonen antall prikker
for profilen innenfor de siste 30 dagene.
Dersom det er $\geq 3$, avvises bookingen.
