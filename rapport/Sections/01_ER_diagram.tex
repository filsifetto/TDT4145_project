...
\begin{enumerate}
    ...
    \item \textbf{Ett tidspunkt, én booking per sal.} For et gitt tidspunkt kan en sal bookes av maksimalt én gruppeaktivitet eller én idrettslagstime. Dette er ikke uttrykt i modellen.
