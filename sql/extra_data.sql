-- TDT4145 Prosjekt - Ekstra testdata
-- Kjores etter insert_data.sql

PRAGMA foreign_keys = ON;

-- ============================================================================
-- Section 1 - More Saler
-- ============================================================================
...
-- ============================================================================
-- Section 2 - Tredemoller
-- 5 tredemoller i Oya styrke-sal (1,2)
-- ============================================================================
...
-- ============================================================================
-- Section 5 - Nye Profiler (ID 16-21)
-- ============================================================================
...
-- Past week: 2026-03-09 to 2026-03-12
-- Current week extras: 2026-03-16 to 2026-03-20
-- ============================================================================
...
-- ============================================================================
-- Section 9 - Pameldt_til
-- Flere profiler for aktiviteter 16.-18. mars med sekvensielle pameldingsnummer
-- ============================================================================

INSERT INTO påmeldt_til
    (senter_ID, sal_ID, gruppeaktivitet_ID, profil_ID, påmelding_nummer)
VALUES
    -- Oya 17. mars 18:30 (ID 7)
    (1, 1, 7, 4, 1),
    (1, 1, 7, 5, 2),
    (1, 1, 7, 6, 3),
    (1, 1, 7, 8, 4),

    -- Dragvoll 17. mars 18:00 (ID 5)
    (2, 1, 5, 9,  1),
    (2, 1, 5, 10, 2),
    (2, 1, 5, 11, 3),
    (2, 1, 5, 16, 4),

    -- Oya 18. mars 17:00 (ID 9)
    (1, 1, 9, 4, 1),
    (1, 1, 9, 8, 2),
    (1, 1, 9, 9, 3),

    -- Oya 16. mars 07:00 (ID 1)
    (1, 1, 1, 5,  1),
    (1, 1, 1, 6,  2),
    (1, 1, 1, 10, 3);

-- ============================================================================
-- Section 10 - Moter_til_gruppe
-- Historisk oppmote for aktiviteter i forrige uke
